...
#define _____________________NUM_R2_5U______________________ S(KC_EQL), S(KC_1), S(KC_2), S(KC_3), KC_TRNS
#define _____________________NUM_R3_5U______________________ S(KC_SCLN), LSFT_T(KC_4), LCTL_T(KC_5), LALT_T(KC_6), S(KC_GRV)
