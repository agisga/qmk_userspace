...
#define _____________________QWERTY_L1______________________ MS_WHLU, _____________________QWERTY_L1_5U______________________
#define _____________________QWERTY_L2______________________ CW_TOGG, _____________________QWERTY_L2_5U______________________
#define _____________________QWERTY_L3______________________ MS_WHLD, _____________________QWERTY_L3_5U______________________
...
#define _____________________QWERTY_R1______________________ _____________________QWERTY_R1_5U______________________, KC_VOLU
#define _____________________QWERTY_R2______________________ _____________________QWERTY_R2_5U______________________, KC_MUTE
#define _____________________QWERTY_R3______________________ _____________________QWERTY_R3_5U______________________, KC_VOLD
...
#define _____________________NUM_R2_5U______________________ S(KC_EQL), LSFT_T(KC_1), LCTL_T(KC_2), LALT_T(KC_3), KC_TRNS
#define _____________________NUM_R3_5U______________________ S(KC_SCLN), S(KC_4), S(KC_5), S(KC_6), S(KC_GRV)
