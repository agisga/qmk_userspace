...
#define _______NUM_LT_2U_______ KC_0, KC_SPC
#define _______NUM_RT_2U_______ KC_TRNS, KC_DOT
#define _______NUM_LT_______ S(KC_MINS), _______NUM_LT_2U_______
#define _______NUM_RT_______ _______NUM_RT_2U_______, KC_COMM
...
#define _____________________FUN_L1_5U______________________ KC_AUTOCLOS_CURLYBRA, KC_AUTOCLOS_SQBRA, KC_AUTOCLOS_PAREN, KC_AUTOCLOS_QUOTE, KC_R_ASSIGN
