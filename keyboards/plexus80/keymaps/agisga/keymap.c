...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-------------------------------------------------------------------------------------------------------------------------------.
     ...
     KC_SLSH,  _____________________QWERTY_L2_5U______________________, KC_1,    KC_2,   KC_3,    _____________________QWERTY_R2_5U______________________, KC_QUOT,   KC_HOME,
  ...
  //,-------------------------------------------------------------------------------------------------------------------------------.
     ...
     LSFT(KC_SLSH),   _____________________NUM_L2_5U______________________,    KC_NO,   KC_NO,   KC_NO,   _____________________NUM_R2_5U______________________, KC_NO,   KC_NO,
